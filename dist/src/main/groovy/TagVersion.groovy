...
def versionArray;
if ( project.properties['hello.project.version'] != null ) {
	versionArray = project.properties['hello.project.version'].split('\\.');
}

if ( project.properties['hello.project.version'].endsWith("-SNAPSHOT") ) {
	...
	project.properties['project.docker.latesttagtimestamp.version']=versionArray[0] + '.' + versionArray[1] + '.' + patchArray[0] + "-SNAPSHOT-"+project.properties['hello.build.timestamp'];
} else {
	...
	project.properties['project.docker.latesttagtimestamp.version']=versionArray[0] + '.' + versionArray[1] + '.' + versionArray[2] + "-STAGING-"+project.properties['hello.build.timestamp'];
}
